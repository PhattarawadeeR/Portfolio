      ...
      <div className="px-[35px]">
        <div className="flex flex-col max-w-[1040px] mx-auto">
          ...
          <div className="flex flex-col">
              ...
              <div className="flex flex-col w-full md:w-1/2">
                ...
                <div>
                  <p className="text-[12px] sm:text-[14px] md:text-[16px] text-grey-02">
                    ...
                    exciting. The logical problem-solving aspect of chemistry
                    has given me a strong foundation for tackling intricate
                    coding tasks. As I delve deeper into HTML, CSS, JavaScript,
                    and various frameworks, I find myself increasingly
                    captivated by the boundless potential to innovate and create
                    user-focused solutions.
                    <br></br>
                    <br></br>
                    Embracing the ever-changing nature of the tech industry, I
                    am dedicated to ongoing learning and professional
                    development. By participating in coding bootcamps,
                    contributing to open-source projects, and networking with
                    experienced developers, I am sharpening my skills and
            ...
            <div className="mb-[60px] md:mb-[100px] sm:mb-[80px]">
              <h2 className="mb-[15px] text-[14px] sm:text-[18px] font-medium text-grey-01 mt-[30px] md:mt-[50px]">
                My Skillsets
              </h2>
              <Slider {...settings}>
                <div
                  style={{ width: 298, marginRight: 50 }}
                  className="rounded-2xl border-2 border-grey p-[25px] h-[200px]"
                >
              ...
              <div className="flex flex-row gap-6 mt-[50px] flex-wrap justify-center">
                <img
