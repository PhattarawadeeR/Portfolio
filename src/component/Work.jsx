    ...
    <section id="Work">
      <div className="px-[35px]">
        <div className="flex flex-col max-w-[1040px] mx-auto">
          ...
          <div className="mt-[50px] mb-[60px] md:mb-[100px] sm:mb-[80px]">
            <div className="">
                  ...
                  <div className="flex flex-col md:flex-row m-10 gap-5">
                    <div className="flex flex-col">
                      ...
                      <p className="text-[14px] sm:text-[16px] text-grey-02">
                        ...
                        features robust e-commerce capabilities to support
                        secure and efficient transactions, enhancing customer
                  ...
                  <div className="max-w-full md:max-w-[495px] rounded-2xl bg-pink-50">
                    <div className="flex flex-col m-10 gap-5">
                      <div className="">
                        ...
                        <p className="text-[14px] sm:text-[16px] text-grey-02">
                          The React app I developed utilizes hooks to
                          effectively call APIs and leverages the Context API
                          for state management. This setup ensures seamless data
                          handling and state sharing across components,
                          enhancing the app's overall functionality and user
                          experience.
                        </p>
                      </div>
                      <a
                  ...
                  <div className="max-w-full md:max-w-[495px] rounded-2xl bg-indigo-50">
                    <div className="flex flex-col m-10 gap-5">
                      <div className="">
                        ...
                        <p className="text-[14px] sm:text-[16px] text-grey-02">
                          I created a static website using HTML and CSS,
                          focusing on simplicity and speed. The site features a
                          clean, intuitive design, ensuring easy navigation and
                          a pleasant user experience without the need for
