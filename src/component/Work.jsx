      ...
      <div className="flex flex-col max-w-[1040px] mx-auto">
        <div className="border-b w-full">
          <div className="flex items-center">
            ...
            <div className="text-[20px] font-bold text-grey-02">
              Selected Work
            </div>
          </div>
        </div>
        <div className="mt-[50px] mb-[100px]">
          <div className="">
            <div className="flex flex-col">
              <div className="max-w-full rounded-2xl bg-lime-100 mb-[50px]">
                <div className="flex flex-row m-10 gap-5">
                  <div className="flex flex-col max-w-[495px]">
                    <h3 className="mb-[15px] text-[20px] font-black text-grey-02">
                      E-Commerce Website
                    </h3>
                  ...
                  <a
                    className="object-cover w-full flex justify-center"
              ...
              <div className="flex flex-row gap-[50px]">
                <div className="max-w-[495px] rounded-2xl bg-pink-100">
                ...
                <div className="max-w-[495px] rounded-2xl bg-indigo-100">
                  <div className="flex flex-col m-10 gap-5">
                    <div className="">
                      <h3 className="mb-[15px] text-[20px] font-black text-grey-02">
                        My Store
